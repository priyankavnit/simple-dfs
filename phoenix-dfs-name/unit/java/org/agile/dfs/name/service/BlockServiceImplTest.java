...
public class BlockServiceImplTest extends BaseNameNodeTestCase {
    ...
    private BlockService blockService = transactionFactory.findService(BlockServiceImpl.class, new String[] { "commit",
            "locate" });
    private static FileService fileService = transactionFactory.findService(FileServiceImpl.class, new String[] {
            "create*", "mk*", "delete*" });
